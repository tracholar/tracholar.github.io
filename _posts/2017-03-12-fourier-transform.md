...
这原本是我在知乎上对[傅立叶变换、拉普拉斯变换、Z变换的联系？为什么要进行这些变换。研究的都是什么？](https://www.zhihu.com/question/22085329/answer/26047106)问题的回答，实际上是我在本科学习数学和信号处理期间的思考，知乎上的答案因为写得仓促，只写了一些大致思想，没有具体展开，也没有图，比较难以理解，这里重新整理了一下，汇成此文。
